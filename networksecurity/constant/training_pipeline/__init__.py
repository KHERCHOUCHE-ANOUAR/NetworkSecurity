...
DATA_VALIDATION_DRITFT_REPORT_DIR : str = "drift_report"
DATA_VALIDATION_DRITFT_REPORT_FILE_NAME : str = "report.yaml"
...
AZURE_STORAGE_ACCOUNT = "netwworksecurity"
AZURE_CONTAINER_NAME = "networksecuritycontainer"